...
@Injectable()
export class InstrumentLifecycleDecisionService {
  ...
  async createDecision(
    ...
    return this.prisma.instrumentLifecycleDecision.create({
      data: {
        ...
        lifecycleDecisionType: input.lifecycleDecisionType,
  ...
  async finalizeDecision(decisionId: string): Promise<InstrumentLifecycleDecision> {
    ...
    if (decision.status !== InstrumentLifecycleDecisionStatus.DRAFT &&
