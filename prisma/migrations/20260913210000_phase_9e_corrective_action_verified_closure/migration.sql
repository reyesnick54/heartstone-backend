-- CreateEnum
DO $$ BEGIN CREATE TYPE "InstrumentControllingDecisionType" AS ENUM ('APPROVE', 'APPROVE_WITH_CONDITIONS', 'REFUSE', 'DEFER', 'SUSPEND', 'PARTIALLY_SUSPEND', 'REVOKE', 'REVOCATION_DECIDED', 'REINSTATE', 'AMEND', 'VARY', 'RENEW', 'REPLACE', 'CORRECT_CLERICAL', 'SURRENDER_ACCEPT', 'CLOSE', 'OTHER'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "InstrumentControllingDecisionStatus" AS ENUM ('DRAFT', 'PENDING', 'FINALIZED', 'SUPERSEDED', 'WITHDRAWN'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "LifecycleOfficialInstrumentType" AS ENUM ('LICENSE', 'PERMIT', 'CERTIFICATE', 'AUTHORIZATION', 'REGISTRATION', 'APPROVAL', 'OTHER'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
-- CreateEnum
DO $$ BEGIN CREATE TYPE "LifecycleOfficialInstrumentStatus" AS ENUM ('DRAFT', 'ISSUED', 'EFFECTIVE', 'AMENDED', 'VARIED', 'RENEWED', 'SUSPENDED', 'PARTIALLY_SUSPENDED', 'REVOCATION_DECIDED', 'REVOKED', 'REINSTATED', 'EXPIRED', 'SURRENDERED', 'SUPERSEDED', 'REPLACED', 'CLOSED'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
-- CreateEnum
DO $$ BEGIN CREATE TYPE "ComplianceRiskLevel" AS ENUM ('LOW', 'MODERATE', 'HIGH', 'CRITICAL'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "ComplianceImmediateActionRoute" AS ENUM ('NONE', 'IMMEDIATE_RESTRICTION', 'PHASE_8_SUSPENSION', 'PHASE_8_REVOCATION', 'RETAINED_NATIONAL_REFERRAL', 'EMERGENCY_ACTION'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
-- CreateEnum
DO $$ BEGIN CREATE TYPE "CorrectiveActionPlanStatus" AS ENUM ('PROPOSED', 'REVIEW_REQUIRED', 'APPROVED', 'IN_PROGRESS', 'EVIDENCE_SUBMITTED', 'VERIFICATION_PENDING', 'PARTIALLY_VERIFIED', 'VERIFIED_COMPLETE', 'OVERDUE', 'FAILED', 'ESCALATED', 'SUPERSEDED', 'CLOSED'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "CorrectiveActionItemStatus" AS ENUM ('PENDING', 'IN_PROGRESS', 'EVIDENCE_SUBMITTED', 'PARTIALLY_VERIFIED', 'VERIFIED', 'FAILED', 'OVERDUE'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "CorrectiveActionSubmissionStatus" AS ENUM ('SUBMITTED', 'UNDER_REVIEW', 'ACCEPTED_FOR_VERIFICATION', 'REJECTED'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "CorrectiveActionVerificationResult" AS ENUM ('VERIFIED', 'PARTIALLY_VERIFIED', 'NOT_VERIFIED', 'UNRESOLVED', 'REINSPECTION_REQUIRED'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "ReinspectionRequirementStatus" AS ENUM ('REQUIRED', 'SCHEDULED', 'COMPLETED', 'WAIVED_BY_AUTHORIZED_DECISION'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "ComplianceFindingClosureStatus" AS ENUM ('ACTIVE', 'SUPERSEDED_BY_REOPENING'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "ComplianceFindingReopeningReason" AS ENUM ('MATERIAL_NEW_EVIDENCE', 'FALSE_OR_MISLEADING_EVIDENCE', 'CORRECTIVE_ACTION_FAILED', 'RECURRENCE', 'AUTHORIZED_REVIEW_MATERIAL_DEFECT'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- CreateEnum
DO $$ BEGIN CREATE TYPE "RootCauseAnalysisMethod" AS ENUM ('STRUCTURED_FIVE_WHY', 'STRUCTURED_FISHBONE', 'STRUCTURED_FAULT_TREE', 'INSTITUTIONAL_REVIEW', 'AI_ASSISTED_DRAFT', 'OTHER_CONTROLLED'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
